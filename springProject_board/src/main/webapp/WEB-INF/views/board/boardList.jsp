...
<script type="text/javascript">
	...
	$("#totalCountSection").append("총 <span class='badge'>" + totalCount + "</span> 개의 게시글이 있습니다");
	});
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
		 ...
		 <div class="panel-body">
			...
			<div align="center">
				<br>
				<a href="/boardInsert" >글 추가</a> &nbsp &nbsp
				<a href="resources/board/boardMain.jsp"><span class="glyphicon glyphicon-home"></span></a> &nbsp &nbsp
